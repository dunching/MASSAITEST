...
struct FCrowdDemoFacingSettings
{
...
struct FCrowdDemoFacingSummary
{
  TArray<FCrowdDemoFacingResult> Results;
...
class MASSAICROWDDEMO_API FCrowdDemoFacingKernel
{
public:
  static void Resolve(
    TConstArrayView<FCrowdDemoFacingInput> Inputs,
